...
const HAIR_BASE: Record<Hair, string> = {
  ...
  neat: "M23,47 C16,12 84,13 77,47 C76,33 62,29 48,33 C42,31 31,32 26,37 C24,40 23,43 23,47 Z",
  ...
  parted: "M23,47 C16,12 84,13 77,47 C75,31 62,29 51,33 Q50,31 49,33 C38,29 25,31 23,47 Z",
